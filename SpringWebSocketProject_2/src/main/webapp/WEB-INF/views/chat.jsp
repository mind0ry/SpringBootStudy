	  ...
	  <div class="row">
	    ...
	    <table class="table">
	      <tbody>
	        ...
	        <tr>
	          <td>
	            <input type="text" v-model="store.receiver" placeholder="상대방" ref="receiver" class="input-sm">
	          </td>
	        </tr>
	        <tr>
	          <td>
	            <input type="text" v-model="store.msg" placeholder="보낼 메세지" ref="msg" size=50 class="input-sm">
	          </td>
	        </tr>
	        <tr>
	          <td>
